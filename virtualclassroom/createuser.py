...
from app.models import User, School, Course, Lecture, Resource
...
def createObjects():
    ...
    course1 = CourseFactory(teacher=teacher, standard='X', school=school)
    lecture11 = LectureFactory(teacher=teacher, course=course1)
    course2 = CourseFactory(teacher=teacher, standard='XI', school=school)
